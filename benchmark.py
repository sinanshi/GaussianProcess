...
#    target_y = np.apply_along_axis(rosenbrock, 1, target_x)
#
#    target_x = train_x
#    target_y = train_y
...
if __name__ == "__main__":
    for i in xrange(3):
        for j in xrange(5):
            test_gpu_set_param(100, 10 * (j + 1))
            test_gpu_set_param(200, 10 * (j + 1))
            test_gpu_set_param(400, 10* (j + 1))
            test_gpu_set_param(800, 10* (j + 1))
